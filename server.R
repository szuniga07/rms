    ...
    output$modify_time_format <- renderUI({
      selectInput("ModifyTimeFmt", "5. Choose the correct time format.",
                  choices = c("31JAN2021", "31JAN21","31-JAN-2021","31-JAN-21","01/31/2021", "01/31/21",
                              "01-31-2021", "01-31-21", "2021-01-31", "21-01-31", "31-JAN-2021 21:15:30 as 1/31/2021",
      ...
      if(is.null(X)) {
        ...
        for(i in 1:length(X)) {
          switch(Format[i],
                 ...
                 "31-JAN-2021 21:15:30 as 1/31/2021" =  df_mod[, X[i]] <- as.Date(df_mod[, X[i]], format="%d-%b-%Y %H:%M:%S"),
...
###################################################################
    ...
    xyplot_Line_Color_Names <- reactive({
      colors()[c(552, 498,652, 254, 26,547, 24, 152, #Main colors
                 8, 13, 32, 52, 63, 68, 85,95, 116, 128,139,
                 142, 147, 367,
                 372, 382,
                 393, 448, 399,405, 450,479,
                 485, 514, 529, 541,
                 562,568, 584, 589, 594, 599,
                 610, 615, 620, 625, 630, 635,640,646,651,657, #Last of single colors
                 553:556, 499:502, 653:656, 255:258,27:30, 548:551, #Primary colors
                 9:12, 14:17, 53:56, 64:67, 69:72, 129:132, 143:146, 148:151,
                 368:371,383:386, 400:403, 406:409, 451:454, 480:483,
                 486:489, 542:545, 569:572, 590:593, 595:598, 600:603, 611:614,
                 626:629, 631:634, 636:639, 647:650,
                 291, 294, 297, 300, 303, 306, 309, 312, 315, 318, 321, 324, 327, #grey
                 330, 333, 336, 339, 342, 345, 348, 351, 354,357,     #grey
                 153,156,159,162,165,168,171,174,177,180,183,186,189,192,195,198,201)] #gray
    })
