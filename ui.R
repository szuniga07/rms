...
h5("Use built-in function, fncAucDcaClass(), in 'Describe' tab to get AUC/Decision Curve/Classification results for each unique prediction as a threshold. See server.r for documentation."),
