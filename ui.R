...
tabPanel("Describe",
         ...
         h5("Calibration Curve, type into #1 above: Calibration.Curve() . Select 'Graph' in #2 (or 'Results' for means). Change the number of bins, text location and size, defaults are: Calibration.Curve(BINS=10, POS=3, CEX=2) . Works for Linear, Poisson, Quantile, GLS, and Logistic models."),
