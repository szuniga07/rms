...
tabPanel("Describe",
         ...
         h5("Calibration Curve, type into #1 above: Calibration.Curve(). Select 'Graph' in #2. Change the number of bins, text size and location, defaults are: Calibration.Curve(BINS=10, POS=3, CEX=2). Works for OLS linear, Poisson, Quantile, and GLS models."),
