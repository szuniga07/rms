      ...
      mainPanel(
        tabsetPanel(                                      #Creates multiple tabs. 
          ...
          tabPanel("Bayesian",
                   ...
                   h5("X-limits can remain blank if the minimum value is specified, beware of trend lines because x-limits (#21-22) are based on Y in #2. Select 'No' for #4 when there is only 1 group for (log-)normal distributions."),
