      ...
      mainPanel(
        tabsetPanel(                                      #Creates multiple tabs. 
          ...
          tabPanel("Bayesian",
                   ...
                   h5("Select 2 parameters to calculate their values (e.g., Par. 1 - Par. 2). Correlations and covariances use colMeans of posteriors (e.g., R of intercepts & slopes), X & Y each requires >= 2 parameters."),
