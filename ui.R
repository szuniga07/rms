...
h6("4. Median hazard ratio: Magnitude of median differences attributed to group differences. E.g., when 2 patients with"),
h6("the same covariate values but in different hospitals are randomly sampled, the hazard ratio comparing the patient"),
h6("with the larger hazard to the patient with the samller hazard ratio will exceed 1.51 in 50% of the samples. If the"),
h6("MHR has the biggest effect, that means the center is the most important thing."),
h6("5. Reduction in the between group variance: The proportion of the random effects variance from a null model (i.e., no covariates)"),
