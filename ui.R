      ...
      mainPanel(
        tabsetPanel(                                      #Creates multiple tabs. 
          ...
          tabPanel("Bayesian",
                   ...
                   h5("Select 2 parameters to compare their difference (e.g., Par. 1 - Par. 2). View 'effect size' by selecting the distribution in #20. Proportions and t-tests: 0.20= small, 0.50= medium, 0.80= large (Cohen, 1988). Continuous outcomes, enter the mean and SD in #1 and #3 (e.g., Mean 1, SD 1 and Mean 2, SD 2)."),
                   ...
                   h5("'Hierarchical OLS' gives trend lines from hierarchical models (see questions 9-10). Enter by types of beta coefficients first (i.e., all B0s before any B1s). Select the 'overall' coefficients first and select 2 colors to highlight the hierarchical estimate."),
