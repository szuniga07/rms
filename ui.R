...
h5("A common option is to select a threshold equal to the prevalence rate. A predicted score above prevalence indicates high risk, a value below prevalence indicates low risk."),
...
h5("Note: The Decision Curve Analysis above is weighted using normal approximation in formulas for continuous outcomes. Below, the curve graph's weights use quantiles."),
...
h5("The 'All treated' line tends to intersect the 'None treated' line at the prevalence line for binary outcomes."),
fluidRow(
  column(5, 
