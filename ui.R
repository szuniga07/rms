...
tabPanel("Bayesian",
         ...
         br(),
         h4("Some functions are from John Kruschke's book, 'Doing Bayesian Data Analysis: A Tutorial with R, JAGS, and Stan' (2nd Ed.)."),
         br(),
...
h5("Make distinct spelling of Theta and Omega names because of character matching (e.g., 'muOfY' & 'muOfOY' instead of 'muOfY' & 'muOfYO')."),
br(),
fluidRow(   
  column(3, 
...
br(),
h5("Select values from a Beta, Log-normal, or Normal distribution to calculate the predicted probabilities above that value. Carefully approximate t distribution with 'Normal'."),
h5("Select quantile values from a Beta, Log-normal, or Normal distribution to calculate the predicted percentile for that value."),
br(),
fluidRow(   
  column(3, 
...
h5("Consider the median central tendency if probabilities appear unlikely because the mode may randomly be the highest value."),
