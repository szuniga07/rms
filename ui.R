      ...
      mainPanel(
        tabsetPanel(                                      #Creates multiple tabs. 
          ...
          tabPanel("Bayesian",
                   ...
                   br(),
                   h4("Check how posterior lines fit data from Normal, Log-normal, Skew-normal, t, or Weibull distributions."),
                   ...
                   br(),
                   h5("Select values from a Beta, Normal, Log-normal, Skew-normal, t, or Weibull distribution to calculate the predicted probabilities above that value. Skew-normal calculations are slow."),
                   h5("Select quantile values from a Beta, Normal, Log-normal, Skew-normal, t, or Weibull distribution to calculate the predicted percentile for that value."),
                   br(),
                   fluidRow(   
                     column(3, 
